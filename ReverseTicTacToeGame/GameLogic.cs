...
namespace ReverseTicTacToeGame
{
    internal class GameLogic
    {
        ...
        private static bool thereIsWin((int row, int column) i_Point, eSignsOfPlayers i_PlayerSign)
        {
        ...
        private static bool checkWinInAntiDiagonal(eSignsOfPlayers i_PlayerSign, int i_NumberOfSignsToWin)
        {
            int counter = 0;
